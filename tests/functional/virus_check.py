...
from services.microservices.virus_check import VirusCheck

base_path = dirname(dirname(dirname(abspath(__file__))))


class VirusCheckTestCase(ProcessingTestCase):

    @classmethod
    def setUpClass(self):
        super(VirusCheckTestCase, self).setUpClass()

    @classmethod
    def tearDownClass(self):
        super(VirusCheckTestCase, self).tearDownClass()
