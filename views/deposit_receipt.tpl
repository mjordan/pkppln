<entry xmlns="http://www.w3.org/2005/Atom" xmlns:sword="http://purl.org/net/sword/">
    ...
    <link rel="http://purl.org/net/sword/terms/add" href="{{sword_server_base_url}}/api/sword/2.0/cont-iri/{{on_behalf_of}}/{{deposit_uuid}}/edit" />
    <link rel="edit" href="{{sword_server_base_url}}/api/sword/2.0/cont-iri/{{on_behalf_of}}/{{deposit_uuid}}/edit" />
    <link rel="http://purl.org/net/sword/terms/statement" type="application/atom+xml;type=feed" href="{{sword_server_base_url}}/api/sword/2.0/cont-iri/{{on_behalf_of}}/{{deposit_uuid}}/state" />
</entry>
